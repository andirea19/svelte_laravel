...
function createInstance(defaultConfig) {
  ...
  const instance5 = bind(Axios_default.prototype.request, context);
  utils_default.extend(instance5, Axios_default.prototype, context, { allOwnKeys: true });
  utils_default.extend(instance5, context, null, { allOwnKeys: true });
  instance5.create = function create(instanceConfig) {
...
function create_if_block(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(19:0) {#if $store.component}",
    ctx
  });
  return block;
}
function create_each_block(key_1, ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "each",
    source: "(21:4) {#each children as child, index (component && component.length === index ? $store.key : null)}",
    ctx
  });
  return block;
}
function create_default_slot(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: "(20:2) <svelte:component this={component} {...props}>",
    ctx
  });
  return block;
}
...
var h = (component, props, children) => {
  return {
    component,
    ...props ? { props } : {},
    ...children ? { children } : {}
...
function instance($$self, $$props, $$invalidate) {
  ...
  const writable_props = ["component", "props", "children"];
...
var file = "node_modules/@inertiajs/svelte/src/SSR.svelte";
function create_fragment3(ctx) {
  let div;
  let app;
  let div_data_page_value;
  let current;
  app = new App_default({ $$inline: true });
  const block = {
    c: function create() {
      div = element("div");
      create_component(app.$$.fragment);
      attr_dev(div, "data-server-rendered", "true");
      attr_dev(
        div,
        "id",
        /*id*/
      ...
      attr_dev(div, "data-page", div_data_page_value = JSON.stringify(
        /*initialPage*/
        ctx[1]
      ));
      add_location(div, file, 5, 0, 82);
    },
    l: function claim(nodes) {
      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    },
    ...
    p: function update(ctx2, [dirty]) {
      ...
      2 && div_data_page_value !== (div_data_page_value = JSON.stringify(
        ...
        attr_dev(div, "data-page", div_data_page_value);
      }
    },
    i: function intro(local) {
      if (current)
...
function instance3($$self, $$props, $$invalidate) {
  let { $$slots: slots = {}, $$scope } = $$props;
  validate_slots("SSR", slots, []);
  let { id, initialPage } = $$props;
  $$self.$$.on_mount.push(function() {
    if (id === void 0 && !("id" in $$props || $$self.$$.bound[$$self.$$.props["id"]])) {
      console.warn("<SSR> was created without expected prop 'id'");
    }
    if (initialPage === void 0 && !("initialPage" in $$props || $$self.$$.bound[$$self.$$.props["initialPage"]])) {
      console.warn("<SSR> was created without expected prop 'initialPage'");
    }
  });
  const writable_props = ["id", "initialPage"];
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot")
      console.warn(`<SSR> was created with unknown prop '${key}'`);
  });
  $$self.$$set = ($$props2) => {
    if ("id" in $$props2)
  ...
  $$self.$capture_state = () => ({ App: App_default, id, initialPage });
  $$self.$inject_state = ($$props2) => {
    if ("id" in $$props2)
      $$invalidate(0, id = $$props2.id);
    if ("initialPage" in $$props2)
...
var SSR = class extends SvelteComponentDev {
  constructor(options) {
    super(options);
  ...
  get id() {
    throw new Error("<SSR>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
  set id(value) {
    throw new Error("<SSR>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
  get initialPage() {
    throw new Error("<SSR>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
...
var file2 = "node_modules/@inertiajs/svelte/src/Link.svelte";
function create_dynamic_element(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      add_location(svelte_element, file2, 24, 0, 796);
    },
    m: function mount(target, anchor) {
    ...
    p: function update(ctx2, dirty) {
      ...
      if (inertia_action && is_function(inertia_action.update) && dirty & /*as, href, data, method, replace, preserveScroll, preserveState, only, headers, queryStringArrayFormat*/
      1023)
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    source: "(25:0) <svelte:element   this={as}   use:inertia={{     ...(as !== 'a' ? { href } : {}),     data,     method,     replace,     preserveScroll,     preserveState: preserveState ?? method !== 'get',     only,     headers,     queryStringArrayFormat,   }}   {...as === 'a' ? { href } : {}}   {...$$restProps}   on:focus   on:blur   on:click   on:dblclick   on:mousedown   on:mousemove   on:mouseout   on:mouseover   on:mouseup   on:cancel-token   on:before   on:start   on:progress   on:finish   on:cancel   on:success   on:error >",
    ctx
  });
  return block;
}
...
<Link href="${href}" method="${method}" as="button">...</Link>`);
  ...
  $$self.$$.on_mount.push(function() {
    if (href === void 0 && !("href" in $$props || $$self.$$.bound[$$self.$$.props["href"]])) {
      console_1.warn("<Link> was created without expected prop 'href'");
    }
  });
  ...
  $$self.$$set = ($$new_props) => {
    ...
    if ("headers" in $$new_props)
      $$invalidate(8, headers = $$new_props.headers);
    if ("queryStringArrayFormat" in $$new_props)
      $$invalidate(9, queryStringArrayFormat = $$new_props.queryStringArrayFormat);
    if ("$$scope" in $$new_props)
      $$invalidate(11, $$scope = $$new_props.$$scope);
  };
  $$self.$capture_state = () => ({
    beforeUpdate,
    inertia: link_default,
    href,
    as,
    data,
    method,
  ...
  $$self.$inject_state = ($$new_props) => {
    ...
    if ("preserveScroll" in $$props)
      $$invalidate(5, preserveScroll = $$new_props.preserveScroll);
    if ("preserveState" in $$props)
      $$invalidate(6, preserveState = $$new_props.preserveState);
    if ("only" in $$props)
      $$invalidate(7, only = $$new_props.only);
    if ("headers" in $$props)
      $$invalidate(8, headers = $$new_props.headers);
    if ("queryStringArrayFormat" in $$props)
      $$invalidate(9, queryStringArrayFormat = $$new_props.queryStringArrayFormat);
  };
  if ($$props && "$$inject" in $$props) {
    $$self.$inject_state($$props.$$inject);
...
var Link = class extends SvelteComponentDev {
  ...
  get queryStringArrayFormat() {
    throw new Error("<Link>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
  set queryStringArrayFormat(value) {
    throw new Error("<Link>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
};
...
function useRemember(initialState, key) {
  const restored = Oe.restore(key);
  const store2 = writable(restored !== void 0 ? restored : initialState);
  const unsubscribe = store2.subscribe((state) => Oe.remember(state, key));
  onDestroy(unsubscribe);
  return store2;
}
var remember_default = useRemember;
...
function useForm(...args) {
  ...
  const store2 = writable({
    ...
    defaults(key, value) {
      ...
      defaults2 = Object.assign(defaults2, value ? { [key]: value } : key);
      return this;
    },
    reset(...fields) {
      if (fields.length === 0) {
  ...
  store2.subscribe((form) => {
    if (form.isDirty === (0, import_lodash.default)(form.data(), defaults2)) {
...
export {
  ...
  createInertiaApp,
  link_default as inertia,
  page_default as page,
  remember_default as remember,
  Oe as router,
...
nprogress/nprogress.js:
   ...
   * @license MIT *)
*/
//# sourceMappingURL=@inertiajs_svelte.js.map
